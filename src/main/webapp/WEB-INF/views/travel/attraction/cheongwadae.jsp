...
<div class="content">
			          ...
			          <ul class="ImgList">
                        <li class="imgList0">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/attraction/cheongwadae_1.jpg"  alt="청와대"><p class="roll_txtline"></p>
                            </div>
                        </li>
                        <li class="imgList1">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/attraction/cheongwadae_2.jpg" alt="청와대"><p class="roll_txtline"></p>
                            </div>
                        </li>
                        <li class="imgList1">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/attraction/cheongwadae_3.jpg" alt="청와대"><p class="roll_txtline"></p>
                            </div>
                        </li>
                    </ul>
                </div>
	...
	<div class="subtitle">상세 정보</div>
	 <div id="info">
	 청와대는 대통령의 집무실·접견실·회의실 및 주거실 등이 있는 본관과 비서실·경호실·춘추관·영빈관 등 부속건물로 되어 있고 넓은 정원과 북악산(北岳山)으로 이어지는 후원(後園) 및 연못이 있다. 본관은 2층 화강암 석조에 청기와[靑瓦]를 덮었다. ‘청와대’라는 명칭은 여기서 유래한 것이다.
이곳은 일찍이 고려시대에 남경(南京)으로서의 별궁(別宮)이 있던 터이다. 조선시대에 들어와 1426년(세종 8) 경복궁(景福宮)을 창건하면서 궁궐 후원으로 삼아 이곳에 연무장(鍊武場), 융무당(隆武堂), 경농재(慶農齋) 및 과거장(科擧場)이 마련되었으며, 왕의 친경지(親耕地)로도 사용되었다.
	</div>
	</div>
	<div class="mapWrap">	
		<div id="map"></div>
		<div class="mapInfo">
			<div class="address">
				<div class="mAddr"><span>주소</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;서울 종로구 청와대로 1</div>
				<div class="price"><span>예약 홈페이지</span> &nbsp;&nbsp;&nbsp;reserve.opencheongwadae.kr</div>
			</div>
		</div>
	</div>
	</div>
...
// 주소로 좌표를 검색합니다
geocoder.addressSearch('서울 종로구 청와대로 1', function(result, status) {
