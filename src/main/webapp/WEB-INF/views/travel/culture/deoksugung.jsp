...
<div class="content">
			          ...
			          <ul class="ImgList">
                        <li class="imgList0">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/culture/deoksugung_1.jpg"  alt="덕수궁"><p class="roll_txtline"></p>
                            </div>
                        </li>
                        <li class="imgList1">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/culture/deoksugung_2.png" alt="덕수궁"><p class="roll_txtline"></p>
                            </div>
                        </li>
                        <li class="imgList2">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/culture/deoksugung_3.png"  alt="덕수궁"><p class="roll_txtline"></p>
                            </div>
                        </li>
                    </ul>
                </div>
	...
	<div class="subtitle">상세 정보</div>
	 <div id="info">
	덕수궁은 처음 월산대군의 집터였던 것을 임진왜란 이후 선조의 임시거처로 사용되어 정릉동 행궁으로 불리다가 광해군 때에 경운궁으로 개칭되었다. 이후 1907년 순종에게 양위한 고종이 이곳에 머무르게 되면서 고종의 장수를 빈다는 의미에서 덕수궁(德壽宮)이라 다시 바꾸었다. 1963년 1월 18일에 사적 제124호로 지정되었다.
	</div>
	</div>
	<div class="mapWrap">	
		<div id="map"></div>
		<div class="mapInfo">
			<div class="address">
				<div class="mAddr"><span>주소</span> &nbsp;&nbsp;&nbsp;서울 중구 세종대로 99 덕수궁</div>
				<div class="homepage"><span>전화</span> &nbsp;&nbsp; 02-771-9951</div>
				<div class="price"><span>가격</span> &nbsp;&nbsp;&nbsp;어른 1,000원  단체 800원</div>
			</div>
		</div>
	</div>
	</div>
...
// 주소로 좌표를 검색합니다
geocoder.addressSearch('서울 중구 세종대로 99', function(result, status) {
