...
<body>
    <div id="wrap">
        ...
        <div class="title">
        <h2 id="locationName">서대문 형무소 역사관</h2>
        </div>
<div class="content">
		<div class="imageWrap">
			          ...
			          <ul class="ImgList">
                        <li class="imgList0">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/museum/seodaemunPrison_1.jpg"  alt="서대문형무소역사관"><p class="roll_txtline"></p>
                            </div>
                        </li>
                        <li class="imgList1">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/museum/seodaemunPrison_2.jpg" alt="서대문형무소역사관"><p class="roll_txtline"></p>
                            </div>
                        </li>
                        <li class="imgList2">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/museum/seodaemunPrison_3.jpg"  alt="서대문형무소역사관"><p class="roll_txtline"></p>
                            </div>
                        </li>
                    </ul>
                </div>
...
서대문독립공원 내에 있으며 3.1운동 직후 유관순 열사가 투옥되어 숨을 거둔 지하 옥사와 감시탑, 고문실, 사형장, 옥사 7개동, 역사전시관 등으로 구성되어 있다.
	...
	<div class="mapWrap">	
		...
		<div class="mapInfo">
			<div class="address">
				<div class="mAddr"><span>주소</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;서울 서대문구 통일로 251 서대문형무소역사관</div>
				<div class="homepage"><span>홈페이지</span> &nbsp;&nbsp;sphh.sscmc.or.kr</div>
				<div class="price"><span>전화</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;02-360-8590</div>
			</div>
		</div>
	</div>
	</div>
...
// 주소로 좌표를 검색합니다
geocoder.addressSearch('서울 서대문구 통일로 251', function(result, status) {
