...
<body>
    <div id="wrap">
        ...
        <div class="title">
        <h2 id="locationName">국립 중앙 박물관</h2>
        </div>
<div class="content">
		<div class="imageWrap">
			          ...
			          <ul class="ImgList">
                        <li class="imgList0">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/museum/nationalMuseum_1.jpg"  alt="국립중앙박물관"><p class="roll_txtline"></p>
                            </div>
                        </li>
                        <li class="imgList1">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/museum/nationalMuseum_2.jpg" alt="국립중앙박물관"><p class="roll_txtline"></p>
                            </div>
                        </li>
                        <li class="imgList2">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/museum/nationalMuseum_3.jpg"  alt="국립중앙박물관"><p class="roll_txtline"></p>
                            </div>
                        </li>
                    </ul>
                </div>
	...
	<div class="subtitle">상세 정보</div>
	 <div id="info">
	 2005년 10월 개관한 국립중앙박물관은 30만㎡의 방대한 공간에 30만여 점(2012년 1월 기준)의 유물을 보관, 전시하는 세계적 규모의 박물관이다. 용산의 옛 주한미군부대 자리에 위치한 이곳은 자연과 인공의 조화를 소중히 여긴 선조들의 지혜를 이어받아 호수와 정원이 어우러지게 설계를 하였으며 남산과 한강이 둘러싸는 ‘배산임수(背山臨水)’의 장소에 자리 잡았다.
	 </div>
	</div>
	<div class="mapWrap">	
		<div id="map"></div>
		<div class="mapInfo">
			<div class="address">
				<div class="mAddr"><span>주소</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;서울 용산구 서빙고로 137 국립중앙박물관</div>
				<div class="homepage"><span>홈페이지</span> &nbsp;&nbsp;www.museum.go.kr</div>
				<div class="price"><span>전화</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;02-2077-9000</div>
			</div>
		</div>
	</div>
	</div>
