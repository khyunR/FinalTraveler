...
<body>
    <div id="wrap">
        ...
        <div class="title">
        <h2 id="locationName">국립 현대 미술관 서울</h2>
        </div>
<div class="content">
		<div class="imageWrap">
			          ...
			          <ul class="ImgList">
                        <li class="imgList0">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/museum/contemporaryArt_1.jpg"  alt="국립현대미술관"><p class="roll_txtline"></p>
                            </div>
                        </li>
                        <li class="imgList1">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/museum/contemporaryArt_2.jpg" alt="국립현대미술관"><p class="roll_txtline"></p>
                            </div>
                        </li>
                        <li class="imgList2">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/museum/contemporaryArt_3.jpg"  alt="국립현대미술관"><p class="roll_txtline"></p>
                            </div>
                        </li>
                    </ul>
                </div>
	...
	<div class="subtitle">상세 정보</div>
	 <div id="info">
서울특별시 종로구 삼청로 30(소격동 165번지)에 위치하고 있는 지상 3층과 지하 3층의 건물로, 2013년 11월 12일에 개관했다. 과거 국군기무사령부(기무사) 건물과 조선시대의 종친부(宗親府) 유적이 자리하고 있는 부지 내에 건립되었다.
	</div>
	</div>
	<div class="mapWrap">	
		<div id="map"></div>
		<div class="mapInfo">
			<div class="address">
				<div class="mAddr"><span>주소</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;서울 종로구 삼청로 30</div>
				<div class="homepage"><span>홈페이지</span> &nbsp;&nbsp;http://www.mmca.go.kr/</div>
				<div class="price"><span>전화</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;02-3701-9500</div>
			</div>
		</div>
	</div>
	</div>
...
// 주소로 좌표를 검색합니다
geocoder.addressSearch('서울 종로구 삼청로 30', function(result, status) {
