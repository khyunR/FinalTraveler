...
<body>
    <div id="wrap">
        ...
        <div class="title">
        <h2 id="locationName">국립 고궁 박물관</h2>
        </div>
<div class="content">
		<div class="imageWrap">
			          ...
			          <ul class="ImgList">
                        <li class="imgList0">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/museum/palaceMuseum_1.jpg"  alt="국립고궁박물관"><p class="roll_txtline"></p>
                            </div>
                        </li>
                        <li class="imgList1">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/museum/palaceMuseum_2.jpg" alt="국립고궁박물관"><p class="roll_txtline"></p>
                            </div>
                        </li>
                        <li class="imgList2">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/museum/palaceMuseum_3.jpg"  alt="국립고궁박물관"><p class="roll_txtline"></p>
                            </div>
                        </li>
                    </ul>
                </div>
	...
	<div class="subtitle">상세 정보</div>
	 <div id="info">
1908년 창경궁 내의 황실박물관으로 개관하여 다음 해 일반에게 공개되었다. 일제강점기인 1938년 이왕가박물관으로 명칭이 격하되었으며 1946년 3월 덕수궁미술관으로 개칭하였다. 1961년 덕수궁사무소를 설치하였고 1969년 5월 덕수궁미술관이 국립박물관으로 통합/개편되었다.
	 </div>
	</div>
	<div class="mapWrap">	
		<div id="map"></div>
		<div class="mapInfo">
			<div class="address">
				<div class="mAddr"><span>주소</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;서울 종로구 효자로 12 국립고궁박물관</div>
				<div class="homepage"><span>전화</span> &nbsp;&nbsp;02-3701-7500</div>
				<div class="price"><span>입장료</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;무료</div>
			</div>
		</div>
	</div>
	</div>
...
// 주소로 좌표를 검색합니다
geocoder.addressSearch('서울 종로구 효자로 12', function(result, status) {
