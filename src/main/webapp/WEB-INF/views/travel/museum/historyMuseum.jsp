...
<body>
    <div id="wrap">
        ...
        <div class="title">
        <h2 id="locationName">서울 역사 박물관</h2>
        </div>
<div class="content">
		<div class="imageWrap">
			          ...
			          <ul class="ImgList">
                        <li class="imgList0">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/museum/historyMuseum_1.jpg"  alt="서울역사박물관"><p class="roll_txtline"></p>
                            </div>
                        </li>
                        <li class="imgList1">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/museum/historyMuseum_2.jpg" alt="서울역사박물관"><p class="roll_txtline"></p>
                            </div>
                        </li>
                        <li class="imgList2">
                            <div class="roll_content">
                                <img src="../../resources/images/travel/museum/historyMuseum_3.jpg"  alt="서울역사박물관"><p class="roll_txtline"></p>
                            </div>
                        </li>
                    </ul>
                </div>
	...
	<div class="subtitle">상세 정보</div>
	 <div id="info">
	 서울역사박물관은 조선시대부터 현재에 이르기까지의 서울의 역사와 문화를 정리하여 보여주는 서울도시역사박물관입니다.
	 도시 서울의 역사를 담은 세계에서 유일한 박물관으로 상설전시실, 기획전시실, 기증유물전시실, 교육실, 강당, 뮤지엄샵이 있으며 전통문화체험교실, 아이좋은 박물관 등 대상별 맞춤 교육프로그램과 음악회 등 다양한 문화프로그램을 운영하고 있습니다.
	 </div>
	</div>
	<div class="mapWrap">	
		<div id="map"></div>
		<div class="mapInfo">
			<div class="address">
				<div class="mAddr"><span>주소</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;서울 종로구 새문안로 55</div>
				<div class="homepage"><span>홈페이지</span> &nbsp;&nbsp;museum.seoul.go.kr</div>
				<div class="price"><span>운영 시간</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;09:00 - 18:00 매주 월요일 정기휴무</div>
			</div>
		</div>
	</div>
	</div>
...
// 주소로 좌표를 검색합니다
geocoder.addressSearch('서울 종로구 새문안로 55', function(result, status) {
